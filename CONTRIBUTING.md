Contributing to ROJO Coin Core
==================================

The ROJO Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ROJO Coin Core project, and is not to be
confused with overall ROJO Coin Network Protocol consensus changes.

Whether a pull request is merged into ROJO Coin Core rests with the project merge
...
Patches that change ROJO Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ROJO Coin consensus, it must have been
...
The project leader is the release manager for each ROJO Coin Core release.
